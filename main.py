...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (tiles.tileIs(current_location, assets.tile`myTile1`)) {
        tiles.setTileAt(current_location, assets.tile`myTile14`)
    }
})
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    current_location = tiles.locationOfSprite(mySprite)
    if (tiles.tileIs(current_location, assets.tile`myTile14`)) {
...
let shop_map = tiles.tileIs(current_location, assets.tile`myTile0`)
